...
const resizeHandleModule = ResizablePrimitive as unknown as {
  PanelResizeHandle?: React.ComponentType<ResizeHandleProps>;
  ResizeHandle?: React.ComponentType<ResizeHandleProps>;
};

const ResizeHandleComponent =
  resizeHandleModule.PanelResizeHandle ?? resizeHandleModule.ResizeHandle;
...
const ResizeHandle = ResizeHandleComponent;
